...
If (actor2= 0) Then
	...
	;rajat
	If (x4 < ukko_vasenraja) Then 
		act2 = 2
		pause = 1
		suunta_c2= 1
		cpu_timer2= MilliSecs()
	EndIf
	If (x4 > ukko_oikearaja) Then 
		act2 = 3
		pause = 1
		suunta_c2= 0
		cpu_timer2= MilliSecs()
...
If (isku4> 1) Then
        If (isku4= 18 And (MilliSecs() > hyppy_timer_cpu2 + 90)) Then ;voltti eteen
                ...
                Else
					...
					If (suunta_c2= 0) Then
						If (x4 < ukko_oikearaja) Then x4 = x4 + 30				
					Else
						If (x4 > ukko_vasenraja) Then x4 = x4 - 30
					EndIf
...
EndIf
;Kävely alkaa
                        If (act2 = (kavely_oikea_cpu) And x4<ukko_oikearaja) Then
;oikealle
								isku4= 0
                                aani_paalle4 = 0
                        ...
                        If (act2 = (kavely_vasen_cpu) And x4>ukko_vasenraja) Then  
;vasemmalle
								isku4= 0
                                aani_paalle4 = 0
                                If (MilliSecs() > ukko_timer44+100) Then
