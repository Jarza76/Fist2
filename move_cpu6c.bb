...
If (actor2= 0) Then
	...
	;rajat
	If (x2 < ukko_vasenraja) Then 
		act2 = 2
		pause2 = 1
		suunta2= 1
		cpu_timer2 = MilliSecs()
	EndIf
	If (x2 > ukko_oikearaja) Then 
		act2 = 3
		pause2 = 1
		suunta2= 0
		cpu_timer2 = MilliSecs()
...
EndIf
;Kävely alkaa
                        If (act2 = (kavely_oikea_cpu) And x2<ukko_oikearaja) Then
;oikealle
								isku2 = 0
                                aani_paalle2 = 0
                        ...
                        If (act2 = (kavely_vasen_cpu) And x2>ukko_vasenraja) Then  
;vasemmalle
								isku2 = 0
                                aani_paalle2 = 0
                                If (MilliSecs() > ukko_timer2+100) Then
