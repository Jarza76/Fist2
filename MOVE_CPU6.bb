...
If (actor = 0) Then
	...
	;rajat
	If (x3 < ukko_vasenraja) Then 
		act = 2
		pause = 1
		suunta_c = 1
		cpu_timer = MilliSecs()
	EndIf
	If (x3 > ukko_oikearaja) Then 
		act = 3
		pause = 1
		suunta_c = 0
		cpu_timer = MilliSecs()
...
If (isku3 > 1) Then
        If (isku3 = 18 And (MilliSecs() > hyppy_timer_cpu + 90)) Then ;voltti eteen
                ...
                Else
					...
					If (suunta_c = 0) Then
						If (x3 < ukko_oikearaja) Then x3 = x3 + 30				
					Else
						If (x3 > ukko_vasenraja) Then x3 = x3 - 30
					EndIf
        ...
        If ((isku3 = 3) And (MilliSecs() > ukko_timer3 + 40)) Then
                If (suunta_c = 1) Then
                         If (x3<ukko_oikearaja) Then
                                x3 = x3 + 24
...
EndIf
;Kävely alkaa
                        If (act = (kavely_oikea_cpu) And x3<ukko_oikearaja) Then
;oikealle
								isku3 = 0
                                aani_paalle3 = 0
                        ...
                        If (act = (kavely_vasen_cpu) And x3>ukko_vasenraja) Then  
;vasemmalle
								isku3 = 0
                                aani_paalle3 = 0
                                If (MilliSecs() > ukko_timer33+100) Then
