...
If (isku2 > 1) Then
        If (isku2 = 18 And (MilliSecs() > hyppy_timer2 + 90)) Then ;voltti eteen
                ...
                Else
					...
					If (suunta2 = 1) Then
						If (x2 < ukko_oikearaja) Then x2 = x2 + 30				
					Else
						If (x2 > ukko_vasenraja) Then x2 = x2 - 30
					EndIf
...
;K‰vely alkaa
                        If ((Not KeyDown(n2_control)) And (JoyDown(2) = 0) And KeyDown(kavely_oikea2) And x2<ukko_oikearaja) Then
;oikealle
								isku2 = 0
                                aani_paalle2 = 0
                        ...
                        If ((Not KeyDown(n2_control)) And (JoyDown(2) = 0) And KeyDown(kavely_vasen2) And x2>ukko_vasenraja) Then  
;vasemmalle
								isku2 = 0
                                aani_paalle2 = 0
                                If (MilliSecs() > ukko_timer2+100) Then
